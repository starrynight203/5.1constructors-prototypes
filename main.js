...
function Dog(params){ //params = new Dog objects ('color' & "hungry") and their values
  params = params || {};
  _.defaults(params,{ // anything that doesn't have an object&value by default we are giving them one
    hungry: true
  });
  this.status = "normal";
  _.extend(this, params); //"this" is how we reference the instance we are creating. params will either reference what we pass in or an empty object if nothing gets passed in
